...
AVALIACAO_END    = '2026-02-28'  # ← atualizar todo mês antes de rodar
...
CARTA_MENSAL = {
    ...
    "corpo": [
        ...
        "Alpha de {alpha} no período está dentro do esperado para uma estratégia estruturalmente defensiva. O IBOV encerrou {ibov} puxado por ativos de alto beta que intencionalmente não carregamos. O portfólio não foi construído para ganhar em janeiro — foi construído para não perder em dezembro de 2027."
    ]
}
